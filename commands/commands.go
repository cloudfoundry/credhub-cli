...
type CredhubCommand struct {
	...
	CreatePermission CreatePermissionCommand `command:"create-permission" description:"Create permissions for an actor on a given path." long-description:"Create permissions for an actor on a given path."`
