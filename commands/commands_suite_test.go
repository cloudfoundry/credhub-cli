...
const STRING_CREDENTIAL_OVERWRITE_REQUEST_JSON = `{"type":"%s","name":"%s","value":"%s","mode":"%s"}`
const JSON_CREDENTIAL_OVERWRITE_REQUEST_JSON = `{"name":"%s","mode":"%s","type":"json","value":%s}`
const CERTIFICATE_CREDENTIAL_REQUEST_JSON = `{"type":"certificate","name":"%s","value":{"ca":"%s","certificate":"%s","private_key":"%s"},"mode":"%s"}`
const CERTIFICATE_CREDENTIAL_WITH_NAMED_CA_REQUEST_JSON = `{"type":"certificate","name":"%s","value":{"ca_name":"%s","ca":"","certificate":"%s","private_key":"%s"},"mode":"%s"}`
const GENERATE_CREDENTIAL_REQUEST_JSON = `{"name":"%s","type":"%s","mode":"%s","parameters":%s}`
const RSA_SSH_CREDENTIAL_REQUEST_JSON = `{"type":"%s","name":"%s","value":{"public_key":"%s","private_key":"%s"},"mode":"%s"}`
const GENERATE_DEFAULT_TYPE_REQUEST_JSON = `{"name":"%s","type":"password","mode":"%s","parameters":%s}`
const USER_GENERATE_CREDENTIAL_REQUEST_JSON = `{"name":"%s","type":"user","mode":"%s","parameters":%s,"value":%s}`
const USER_SET_CREDENTIAL_REQUEST_JSON = `{"type":"user","name":"%s","value":%s,"mode":"%s"}`
